  ...
  <Card.Group>
    <Card color="blue">
      <Card.Content color="blue">
        ...
        <Card.Description>
          ...
          THE NOOK HOUSE, KISERIAN TOWN, KISERIAN, NAIROBI, KENYA
        </Card.Description>
        <br />
        <Card.Description>
          <Icon name="envelope" color="blue" />
          P.o Box 391 00206 Kajiado, Kenya.
        </Card.Description>
      </Card.Content>
    </Card>
    <Card color="red">
      <Card.Content color="red">
        ...
        <Card.Description color="blue">
          ...
          wellofhopeinternational@yahoo.co.uk
        </Card.Description>
        <br />
        {/* <Card.Description>
            <Icon name='at' color='red'/>
    ...
    <Card color="green">
      <Card.Content>
        ...
        <Card.Description>
          <Icon name="text telephone" color="green" />
          (+254) 713 510 766
        </Card.Description>
      </Card.Content>
    </Card>
